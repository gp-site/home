    ...
    (async function () {
        ...
        function loadScript(file) {
            return new Promise(function (resolve, reject) {
                ...
                script.src = (typeof EJS_paths !== 'undefined' && typeof EJS_paths[file] === 'string')
                    ? EJS_paths[file]
                    : (file === "emulator.min.js" ? scriptPath + file : scriptPath + "src/" + file);
        ...
        async function filesmissing(file) {
            ...
            if (file.includes(".min.") && !file.includes("socket")) {
                console.warn("Arquivo minificado não encontrado. Tentando carregar arquivos não-minificados.");
        ...
        if (typeof window.EJS_language === "string" && window.EJS_language !== "en-US") {
            try {
                let path = (typeof EJS_paths !== 'undefined' && typeof EJS_paths[window.EJS_language] === 'string')
                    ? EJS_paths[window.EJS_language]
                    : scriptPath + "localization/" + window.EJS_language + ".json";
